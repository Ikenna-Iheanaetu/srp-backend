...
import { SavedAffiliateFilters } from "../query-factory";
...
} as const satisfies Record<keyof SavedAffiliateFilters, DropdownFiltersData>;

const filterKeys = Object.keys(filtersMap) as (keyof SavedAffiliateFilters)[];

export const filterParsers = createFilterParsers(
	filterKeys.reduce((acc, key) => {
		acc[key] = [];
		return acc;
	}, {} as Record<keyof SavedAffiliateFilters, string[]>)
);

export const SavedAffiliatesFiltersBlock: React.FC = () => {
