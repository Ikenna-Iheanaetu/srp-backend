...
interface TailwindContainerProps
  extends Omit<React.ComponentProps<typeof Tailwind>, "config" | "children"> {
  config?: TailwindConfig | ((config: TailwindConfig) => TailwindConfig);
  children: React.ReactNode;
}

/**Already wrapped with `<Html>` and `<Head>` */
