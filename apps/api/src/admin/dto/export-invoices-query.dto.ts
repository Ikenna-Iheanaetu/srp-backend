...
import { InvoiceTab } from './get-invoices-query.dto';
import { zodEnumTransform } from 'src/common/validators';

const ExportInvoicesQuerySchema = z.object({
...
export class ExportInvoicesQueryDto extends createZodDto(ExportInvoicesQuerySchema) {
  @ApiPropertyOptional({
