...
import { columns, HiredCandidate } from "./columns";

export function HiredCandidatesDataTable() {
	...
	const handleViewProfile = (row: Row<HiredCandidate>) => {
