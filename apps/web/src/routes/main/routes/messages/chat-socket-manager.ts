...
interface ServerToClientEvents {
	...
	"chat:accepted": (
		data: { chatId: string } & Pick<AcceptedChat, "expiresAt">,
	) => void;
	"chat:declined": (data: { chatId: string }) => void;
	"chat:ended": (data: { chatId: string }) => void;
	"chat:request-resent": (data: { chatId: string }) => void;
	"chat:expired": (data: { chatId: string }) => void;
	"chat:extended": (
		data: { chatId: string } & Pick<AcceptedChat, "expiresAt">,
	) => void;
